...
for (let i = 0; i < 520; i++) {
  ...
  const order = {
    ...
    '市': city,
    '区': district,
    '街道/镇': city+'市'+district+street+rnd(1,300)+'号',
    '收货人': '用户' + rnd(100,999),
    '收货人手机': rndPhone(),
    '买家留言': Math.random()<0.15 ? pick(['请尽快发货','麻烦包装好一点','发之前检查一下质量','送人用请精美包装','到货前短信通知']) : '',
    '商家备注': Math.random()<0.1 ? pick(['老客户','加急发货','要赠品','VIP客户']) : '',
