...
export default function ProfitBreakdownDrawer({
  ...
  const costItems: CostItem[] = [
    ...
    { label: '平台佣金', amount: platformFee, source: '货款明细/公式', sourcePath: `货款明细CSV → 平台技术服务费 或 商家实收 × 佣金率`, icon: <Database size={14} />, color: '#0891b2' },
          ...
          <div className="bg-pdd-bg rounded-xl p-4">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2 pt-1 border-t border-pdd-border">
                ...
                <span className={`text-[10px] font-bold shrink-0 ${netProfit >= 0 ? 'text-green-600' : 'text-red-600'}`}>{profitRate.toFixed(1)}%</span>
              </div>
            </div>
          </div>
