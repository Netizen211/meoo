...
export const DEFAULT_AMOUNT_FIELDS: FilterField[] = [
  ...
  { key: 'productCost', label: '商品成本', hint: '60%售价', group: 'cost', compute: (o) => (parseFloat(String(o['商品总价(元)'] || '0').replace(/[^\d.\-]/g, '')) || 0) * 0.6 },
  { key: 'profit', label: '利润金额', hint: '实收-成本-邮费', group: 'cost', compute: (o) => (parseFloat(String(o['商家实收金额(元)'] || '0').replace(/[^\d.\-]/g, '')) || 0) - (parseFloat(String(o['商品总价(元)'] || '0').replace(/[^\d.\-]/g, '')) || 0) * 0.6 - (parseFloat(String(o['邮费(元)'] || '0').replace(/[^\d.\-]/g, '')) || 0) },
